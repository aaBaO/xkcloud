...
public class CloudRecoEventHandler : MonoBehaviour, ICloudRecoEventHandler
{
	...
	/// <summary>
	/// The _ handlemycloud target.
	/// </summary>
	private HandlemycloudTarget _HandlemycloudTarget = new HandlemycloudTarget();
...
//		else
//		{
//			if(GetMetadata(targetSearchResult).ToString().Equals("notme"))
//			{
//				Debug.Log("NOT ME!!!!!!!!");
//				return;
//			}
//			else
//			{
//				MosesData.Videopath = GetMetadata(targetSearchResult);
//			}
//		}
//
//		if (targetSearchResult.UniqueTargetId.Equals ("34b9135e7f7147b98441be35a37a10c8")) 
//		{
//			MosesData.Xiaochi = true;
//		} 
//		else 
//		{
...
//		}
		...
		{
			//******发送触发事件******
			if(_HandlemycloudTarget.HandleModify(targetSearchResult.UniqueTargetId, GetMetadata(targetSearchResult)) == false)
			{
				return;
			}
			else
			{
				if(_HandlemycloudTarget.DownloadmyVideo(targetSearchResult.UniqueTargetId, GetMetadata(targetSearchResult)))
				{
				...
				Debug.Log("It is my Target!! (" + targetSearchResult.UniqueTargetId + ")");
			}
		}
...
//        }
	...
	{
		//******注册事件******
		_HandlemycloudTarget.ModifycloudRecoTargetEvent += DoModify.DoModifymycloudRecoTargetEvent;
		_HandlemycloudTarget.DownloadVideoEvent += DownloadVideo.DoDownloadmyVideoFromURL;
	}
...
//    }
	...
	private string GetMetadata(TargetFinder.TargetSearchResult targetsearchresult)
	{
		string str = targetsearchresult.MetaData;
		return str;
	}
